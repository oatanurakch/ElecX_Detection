...
- สามารถควบคุมอุปกรณ์ปลายทางได้ ในเบื้องต้นยังไม่สามารถปรับตั้งค่าได้ผ่าน GUI แต่ใช้การ Herd cord ไว้ด้านใน ( มีแผนในการพัฒนาต่อยอด ) <br>
...
- ในเบื้องต้น model ที่แอดไว้ในระบบรวมไปถึงค่า setting ต่าง ๆ ถูกเขียนไปไฟล์ JSON เพื่อทำการ Load config ที่เคยตั้งไว้มาใช้งานในบางส่วน ( มีแผนที่จะพัฒนาต่อให้ทำการบันทึก config ต่าง ๆ ไว้และโหลดมาใช้งานทุกครั้งที่เริ่มโปรแกรมใหม่ และเมื่อมีการปรับตั้งค่าก็บันทึกค่าใหม่ทับเข้าไป ) <br>
